...
function Slider({
  ...
  // A single number is a one-thumb slider. Base UI hands a scalar back to
  // onValueChange in that case, so the thumb count has to follow the same rule or
  // the control renders two thumbs for one value.
